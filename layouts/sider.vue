        ...
        routers: [
          ...
          },
          {
            ...
            children: [
              {
                name: '录入',
                path: '/baseInfo/entering',
                authority: 'jbxx_lr',
              },
              {
                name: '查询',
                path: '/baseInfo/search',
                authority: 'jbxx_cx',
              },
            ],
          },
          {
            name: '监测指标',
            icon: 'iconzhibiaoguanli',
            path: '/monitoringIndex',
            authority: 'jczb',
            children: [
              {
                name: '录入',
                path: '/monitoringIndex/entering',
                authority: 'jczb_lr',
              },
              {
                name: '查询',
                path: '/monitoringIndex/search',
                authority: 'jczb_cx',
              },
              {
                name: '统计',
                path: '/monitoringIndex/statistics',
                authority: 'jczb_tj',
              },
            ],
          },
          {
            ...
            children: [
              {
                name: '查询',
                path: '/evaluationAnalysis/search',
                authority: 'pjfx_cx',
              },
            ],
          },
            ...
            children: [
              {
                name: '部门管理',
                path: '/system/dept',
                authority: 'system_bmgl',
              },
              {
                name: '角色管理',
                path: '/system/role',
                authority: 'system_jsgl',
              },
              {
                name: '用户信息',
                path: '/system/user',
                authority: 'system_yhxx',
              },
              {
                name: '指标信息',
                path: '/system/indexInfo',
                authority: 'system_zbxx',
              },
              {
                name: '指标发布',
                path: '/system/indexPublish',
                authority: 'system_zbfb',
              },
              {
                name: '指标分配',
                path: '/system/indexDistribution',
                authority: 'system_zbfp',
              },
              {
                name: '目标值更新',
                path: '/system/targetUpdate',
                authority: 'system_mbzgx',
              },
              {
                name: '指数配置',
                path: '/system/indexConfig',
                authority: 'system_zspz',
              },
              {
                name: '得分公式配置',
                path: '/system/formulaConfig',
                authority: 'system_dfgspz',
              },
              {
                name: '时间配置',
                path: '/system/timeConfig',
                authority: 'system_sjpz',
              },
            ],
          },
        ],
